...
def get_ase_calculator(engine, charge, mult, method, solvent=None, **kwargs):
    ...
    if engine == "aimnet":
        ...
        from ._gaussian import create_gaussian_calc
        ...
        from ._nwchem import create_nwchem_calc
